...
pch <- c(
   "R-AS (after - early)" = 19, "D-AS (after - early)" = 19,
   "R-AS (after - intermediate)" = 19, "D-AS (after - intermediate)" = 19,
   "R-AS (after - later)" = 19, "D-AS (after - later)" = 19,
   "R-AS (before)" = 17, "D-AS (before)" = 15
)
...
Distance to Donor
```{r}
#png("~/R/Immigration/Transplantation/paper_codes/Figures/Fig.S4-Dist to DAS.png", res = 600, width = 10, height = 5, units = "in", pointsize = 10)
...
```{r}
#png("~/R/Immigration/Transplantation/paper_codes/Figures/Fig.S5-Dist to RAS.png", res = 600, width = 9, height = 5, units = "in", pointsize = 10)
...
ggsave(plot = p_both, filename = "Figures/Figure7 - Barplot models distance immigration.pdf", width = 190, height = 140, dpi = 300, units = "mm")
```
