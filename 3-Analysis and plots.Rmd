...
### Outlet ###
Data <- read.delim(file = "data_raw/Process parameters/NØ_Udløb_1.txt", sep = "\t", header = T, dec = ".", encoding = "UTF-8", na.strings = "NULL") %>% 
...
Data <- read.delim(file = "data_raw/Process parameters/NØ_Udløb_2.txt", sep = "\t", header = T, dec = ".", encoding = "UTF-8", na.strings = "NULL") %>% 
  subset(NOE.outlet.pH > 0 & NOE.outlet.pH < 12) %>% 
  subset(NOE.outlet.Temperature.C > 0 & NOE.outlet.Temperature.C < 100) %>%
  subset(NOE.outlet.NO3.mg.l < 500) %>%
  subset(NOE.outlet.TSS.mg.l < 100)
...
Data <- read.delim(file = "data_raw/Process parameters/NØ_Udløb_3.txt", sep = "\t", header = T, dec = ".", encoding = "UTF-8", na.strings = "NULL") %>% 
  subset(NOE.outlet.pH > 0 & NOE.outlet.pH < 12) %>% 
  subset(NOE.outlet.Temperature.C > 0 & NOE.outlet.Temperature.C < 100) %>%
  subset(NOE.outlet.NO3.mg.l < 500) %>%
  subset(NOE.outlet.TSS.mg.l < 100)
...
Data <- read.delim(file = "data_raw/Process parameters/NØ_Udløb_4.txt", sep = "\t", header = T, dec = ".", encoding = "UTF-8", na.strings = "NULL") %>% 
  subset(NOE.outlet.pH > 0 & NOE.outlet.pH < 12) %>% 
  subset(NOE.outlet.Temperature.C > 0 & NOE.outlet.Temperature.C < 100) %>%
  subset(NOE.outlet.NO3.mg.l < 500) %>%
  subset(NOE.outlet.TSS.mg.l < 100)
...
Data <- read.delim(file = "data_raw/Process parameters/NØ_Udløb_med_po4_LT.txt", sep = "\t", header = T, dec = ".", encoding = "UTF-8", na.strings = "NULL") %>% 
  subset(NOE.outlet.pH > 0 & NOE.outlet.pH < 12) %>% 
  subset(NOE.outlet.Temperature.C > 0 & NOE.outlet.Temperature.C < 100) %>%
  subset(NOE.outlet.NO3.mg.l < 500) %>%
  subset(NOE.outlet.TSS.mg.l < 100)
...
Data <- read.delim(file = "data_raw/Process parameters/NØ_udløb_med_po4_afløb.txt", sep = "\t", header = T, dec = ".", encoding = "UTF-8", na.strings = "NULL") %>% 
  subset(NOE.outlet.pH > 0 & NOE.outlet.pH < 12) %>% 
  subset(NOE.outlet.Temperature.C > 0 & NOE.outlet.Temperature.C < 100) %>%
  subset(NOE.outlet.NO3.mg.l < 500) %>%
  subset(NOE.outlet.TSS.mg.l < 100)
...
#Inlet
Data1 <- read.delim(file = "data_raw/Process parameters/NØ_Analyses_Tilløb_2016.txt", sep = "\t", header = T, dec = ".", encoding = "UTF-8", na.strings = "NULL")
Data2 <- read.delim(file = "data_raw/Process parameters/NØ_Analyses_Tilløb_2017.txt", sep = "\t", header = T, dec = ".", encoding = "UTF-8", na.strings = "NULL")
...
Data <- read.delim(file = "data_raw/Process parameters/NØ_Egenkontrol_Tilløb_Combined.txt", sep = "\t", header = T, dec = ".", encoding = "UTF-8", na.strings = "NULL")
...
Data1 <- read.delim(file = "data_raw/Process parameters/NØ_Analyses_Afløb_2016.txt", sep = "\t", header = T, dec = ".", encoding = "UTF-8", na.strings = "NULL")

Data2 <- read.delim(file = "data_raw/Process parameters/NØ_Analyses_Afløb_2017.txt", sep = "\t", header = T, dec = ".", encoding = "UTF-8", na.strings = "NULL")
...
Data <- read.delim(file = "data_raw/Process parameters/NØ_Egenkontrol_Afløb_Combined.txt", sep = "\t", header = T, dec = ".", encoding = "UTF-8", na.strings = "NULL")
...
```{r Metadata SVI}
### SVI ###
Data <- read.delim(file = "data_raw/Process parameters/NØ_SVI_2017.11.13_gd.txt", sep = "\t", header = T, dec = ".", encoding = "UTF-8", na.strings = "NULL") #%>%
...
Data <- read.delim(file = "data_raw/Process parameters/NØ_SVI.txt", sep = "\t", header = T, dec = ".", encoding = "UTF-8", na.strings = "NULL")
names(Data)[names(Data) == "Date"] <- "StartTime"
SVI2 <-  melt(Data, id = c("StartTime"), measure.vars = colnames(Data)[2:(ncol(Data)-1)], variable.name = "Parameter", value.name = "Value")

Data <- read.delim(file = "data_raw/Process parameters/NØ_SVI_FluxTests.txt", sep = "\t", header = T, dec = ".", encoding = "UTF-8", na.strings = "NULL")
...
```{r Metadata Sludge}
### Sludge ###
Data <- read.delim(file = "data_raw/Process parameters/NØ_Slamrapport_Combined.txt", sep = "\t", header = T, dec = ".", encoding = "UTF-8", na.strings = "NULL") 
names(Data)[names(Data) == "Date"] <- "StartTime"
...
ggsave(plot = fig1, "~/R/Immigration/Transplantation/paper_codes/Figures/Figure1 - Process parameters.pdf", width = 190, height = 130, units = "mm", dpi = 300)
```
...
nmds2 <-ggplot(nmds$data, aes(x = NMDS1, y = NMDS2)) +
        geom_point(aes(color = SampleGroup,  shape=Season), size=1.5, alpha = 0.7) +
        geom_path(aes(group = Plants, color = SampleGroup), alpha = 0.4) +
ggrepel::geom_text_repel(aes(label = Days_lable), colour = "darkgrey", size = 2, segment.alpha = 0.3) +
        theme_bw() +
        ...
        scale_colour_manual(values = c("before" = "black", 
                                  "after-early" = "#8351DA",
                                  "after-intermediate" = "#2D949A",
                                  "after-late" = "#D05801")) +
        annotate("text", x = 0.45, y = 0.05, label = "R-AS", colour = "black", size = 4,  fontface =2) + 
        annotate("text", x = -0.4, y = -0.05, label = "D-AS", colour = "black", size = 4, fontface =2) + 
  
        annotate("text", x = -0.4, y = -0.35, 
             label = paste0(nmds$layers[[2]][["aes_params"]][["label"]]),size = 2.5) +
        annotate("text", 
           x = 0.25,
           y = 0.38, label = "Transplantation", size = 3, 
           #angle = 28, 
           angle = 24, 
           color = "darkred") +
        guides(color=guide_legend(nrow=1, byrow=TRUE,
                                 ...
                                 keyheight=0.05,
                                 default.unit="inch")) +
        geom_segment(aes(x = 0.5, y = 0.42, xend = 0.05, yend = 0.29),
...
pCooman_data$points$ID <- as.character(pCooman_data$points$ID)
pCooman_data$points$ID[pCooman_data$points$ID %in% "R-AS (after - later)"] <- "R-AS (after - late)" #renaming correctly
pCooman_data$points$ID <- factor(pCooman_data$points$ID, levels = c("R-AS (before)", "D-AS (before)", "R-AS (after - early)", "R-AS (after - intermediate)", "R-AS (after - late)"))

#Plot
pCooman <- ggplot(pCooman_data$points, aes(f1, f2)) + 
   geom_point(aes(colour = ID, shape = ID), size = 1.5, alpha = 0.6) + 
   geom_hline(yintercept = pCooman_data$lim1, linetype = "dashed", colour = "black", size = 0.2) + 
   geom_vline(xintercept = pCooman_data$lim2, linetype = "dashed", colour = "black", size = 0.2) +
   labs(x = "Full distance to model R-AS(before)",
        y = "Full distance to model D-AS(before)") +
   theme_bw()+
   theme(#legend.position = "bottom",
         legend.position = c(.68, .80),
  ...
  scale_colour_manual(name = "SampleGroup", 
                     values = c("black", "black", "#8351DA", "#2D949A","#D05801")) +
    scale_shape_manual(name = "SampleGroup",
                      values= c(17, 15, 19, 19, 19)) 
...
ggsave("~/R/Immigration/Transplantation/paper_codes/Figures/Figure2 - NMDS and Cooman.pdf", plot = fig2, width = 190, height = 85, dpi = 300, units = "mm")
```
...
plotVB <- ggplot() +
  ...
  geom_sf_text(aes(label = name), fontface = "bold", size = 4,  data = venn_setlabel(data_before)) +
  geom_sf_label(aes(label=count), size = 2.5, color = "black", data = venn_region(data_before)) +
  theme_void() +
...
plotVA <- ggplot() +
  ...
  geom_sf_text(aes(label = name), fontface = "bold", size = 4,  data = venn_setlabel(data_after)) +
  geom_sf_label(aes(label=count), size = 2.5, color = "black", data = venn_region(data_after)) +
  theme_void() +
  scale_fill_gradient(low="white",high = "red") +
  labs(title = "After",
...
plottest1 <- amp_heatmap(hm_bef,
   ...
   theme(legend.position = "none",
           ...
           axis.text.y = element_text(angle = 0, size = 8,color = "black", face = "bold"), 
           axis.text.x = element_text(angle = 45, size = 8, color = "black", hjust = 1, vjust = 1), 
...
hm_bef1b <-  plottest1 +
   ...
   theme(legend.position = "none",
          # legend.text = element_text(size = 10, face = "bold", color = "black"),
          # legend.title = element_text(size = 10, face = "bold", color = "black"),
           axis.text.y = element_text(angle = 0, size = 10,color = "black", face = "bold"), 
           axis.text.x = element_text(angle = 45, size = 8, color = "black", hjust = 1, vjust = 1), 
           strip.text = element_text(size = 8, face = "bold", color = "black"),
...
ggsave("~/R/Immigration/Transplantation/paper_codes/Figures/Figure3 - Venn and Horizontal Heatmap.pdf", plot = fig3, width = 190, height = 154, dpi = 300, units = "mm")
```
...
####Plot
```{r}
#improving visualization of species name
levels(rec_added2$Species_rename2)[levels(rec_added2$Species_rename2)%in%"Ca_Saccharimonas Ca_Saccharimonas_aalborgensis"] <- "Ca_Saccharimonas_aalborgensis"
...
fig4 <- ggplot(rec_added2, aes(x = Days, y = rra_sp, color=Species_rename2)) + 
        ...
        xlab("Days") + 
        geom_vline(xintercept = 0, linetype = "longdash", color = "black", size = 0.3) +
        ylab("Relative read abundance [%]") + 
        scale_x_continuous(breaks=seq(-140,220,40)) +
...
ggsave(plot = fig4, filename = "~/R/Immigration/Transplantation/paper_codes/Figures/Figure4 - Removal of added species.pdf", width = 140, height = 60, dpi = 1000, units = "mm")
```
   ...
   labs(title = "Before") +
    theme(legend.position = "right",
          legend.key.size = unit(0.3, "cm"),
           ...
           axis.text.x = element_text(angle = 45, size = 5, color = "white", vjust = 1.1, hjust = 1.1), 
           strip.text = element_text(size = 7, face = "bold", color = "black"),
          axis.ticks.y = element_line(linewidth = 0.1),
           axis.ticks.x = element_blank()
    )

plot_hm2$layers[[1]][["aes_params"]][["size"]] <- 0.1 #adjusts tickness of tiles

#ggsave(plot = plot_hm2, filename = "Figures/Fig.5 - HM guilds.jpg", width = 9, height = 10, dpi = 600)#, scale = 2, limitsize = F)
ggsave(plot = plot_hm2, filename = "~/R/Immigration/Transplantation/paper_codes/Figures/Figure5 - HM guilds.pdf", width = 90, height = 100, dpi = 300, units = "mm")#, scale = 2, limitsize = F)
```
...
levels(PAO_un_add_sub$Species_rename2)[levels(PAO_un_add_sub$Species_rename2)%in%"Tetrasphaera Tetrasphaera_australiensis"] <- "Tetrasphaera australiensis" #renaming to improve visualization
 ...
 geom_point(size=0.5, alpha = 0.8) +
  geom_line(size=0.1, alpha = 0.5)+
     theme(legend.position = "bottom",
           ...
           legend.title = element_blank(),
           axis.text.y = element_text(size = 5, color = "black"), 
           axis.text.x = element_text( size = 5, angle = 90, vjust = 0.5, hjust = 0, color = "black"), 
...
levels(PAO_shared_sub$Species_rename2)[levels(PAO_shared_sub$Species_rename2)%in%"Tetrasphaera Tetrasphaera_elongata"] <- "Tetrasphaera elongata" #renaming to improve visualization
...
pao_top5sh <- ggplot(PAO_shared_sub, aes(x = Days, y = rra_sp, color=Plants)) + 
  ...
  geom_line(size=0.1, alpha = 0.5)+
     theme(legend.position = "bottom",
           ...
           axis.line = element_line(linewidth = 0.2),
           axis.text.y = element_text(size = 5, color = "black"), 
           axis.text.x = element_text( size = 5, angle = 90, vjust = 0.5, hjust = 1, color = "black"),            axis.title.x = element_text(size = 6, color = "black"),
           axis.title.y = element_text(size = 6, color = "black"),
           strip.text = element_text(size = 6, face = "bold", color = "black"),
           plot.title = element_text(size=7, face = "bold"),
           plot.subtitle = element_text(size = 5),
...
ggsave(plot = pao_top5both, filename = "~/R/Immigration/Transplantation/paper_codes/Figures/Figure6 - PAOs.pdf", width = 190, height = 82, dpi = 300, units = "mm")
...
plotA <- ggscatter(wide_A, x = "zscore_iww", y = "zscore_as",color = "DaysNew", size = 0.5, alpha = 0.7,
   add = "reg.line",  # Add regressin line
   add.params = list(fill = "lightgray", color = "black", size = 0.5, alpha = 0.1), 
   conf.int = TRUE,
   show.legend.text = NA) +
...
stat_cor(method = "pearson", 
         size = 1.8,
         label.x = -2.5, label.y = 4) +
  theme_bw() +
  theme(legend.position = "none",
        legend.key.size = unit(0.4, "cm"),
        legend.text = element_text(size = 6, color = "black"),
        legend.title = element_text(size = 8),
        strip.text = element_text(size = 6.2, angle = 0),
...
levels(wide_B$Species_rename2)[levels(wide_B$Species_rename2) %in% "Sphingopyxis Sphingopyxis_bauzanensis"] <- "Sphingopyxis bauzanensis" #renaming for better visualization

plotB <- ggscatter(wide_B, x = "zscore_iww", y = "zscore_as", color = "DaysNew", size = 0.5, alpha = 0.7,
   add = "reg.line",  # Add regressin line
  add.params = list(fill = "lightgray", color = "black", size = 0.5), 
   conf.int = TRUE,
   show.legend.text = NA) +
   #facet_grid(cols = vars(Plant)) +
  xlim(-3, 5) +
...
levels(wide_C$Species_rename2)[levels(wide_C$Species_rename2)=="Ca_Microthrix Ca_Microthrix_parvicella"] <- "Ca_Microthrix parvicella" #renaming for better visualization

plotC <- ggscatter(wide_C, x = "zscore_iww", y = "zscore_as",color = "DaysNew", size = 0.5, alpha = 0.7,
   add = "reg.line",  # Add regressin line
   add.params = list(fill = "lightgray", color = "black", size = 0.5), 
   conf.int = TRUE,
   show.legend.text = NA) +
...
pleg <- ggscatter(wide_A, x = "zscore_iww", y = "zscore_as",color = "DaysNew", size = 0.5, alpha = 0.7,
   add = "reg.line",  # Add regressin line
   add.params = list(fill = "lightgray", color = "black", size = 0.5), 
   conf.int = TRUE,
   show.legend.text = NA) +
...
ggsave(plot = p_zscore, filename = "~/R/Immigration/Transplantation/paper_codes/Figures/Figure8 - Zscore.pdf", width = 140, height = 110, dpi = 300, units = "mm")
