...
library(readxl)
library(kableExtra)
load(file = "data_generated/Additional-file-4_fullData001pct2.RData")
...
# jpeg("Figures/Fig.2-Cooman.jpg", width = 500, height = 500)
...
Distance to Donor
```{r}
#jpeg("Figures/Fig.S3-Dist to DAS.jpg", width = 800, height = 400)
par(mfrow = c(1, 2))
...
```{r}
#jpeg("Figures/Fig.S4-Dist to RAS.jpg", width = 800, height = 400)
par(mfrow = c(1, 2))
